...
public class PresencCourseClassAdapter extends RecyclerView.Adapter<PresencCourseClassAdapter.CourseUnitViewHolder> {

    private ArrayList<CourseClass> courseClasses;
    private Context context;
    public static String COURSECLASS = "courseClass";

    public PresencCourseClassAdapter(ArrayList<CourseClass> courseClasses, Context context) {
    ...
    public void onBindViewHolder(@NonNull CourseUnitViewHolder courseUnitViewHolder, int posicao) {
        ...
        courseUnitViewHolder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(context, PresencActivity.class);
